<?php
include_once './common_beautystar.php';
?>
<!DOCTYPE html>
...
<head>
  ...
  <link rel="stylesheet" href="scss/beautystar.min.css">
  <!-- js -->
...
<body>
    ...
    <section class="main">
        <div class="container">
          ...
          <div class="top-infomation">
            <div class="h1" data-aos="fade-down" data-aos-duration="800"><h1>2026美妝種子招募中</h1></div>
            <p class="text_big" data-aos="fade-up" data-aos-duration="800">熱愛美妝、對「美」有獨到觀點的您，<br>絕不能錯過這場年度美學體驗，<br>一同成為美的共同定義者！</p>
            <div class="h2 h2_who" data-aos="fade-down" data-aos-duration="800"><h2>報名資格</h2></div>
            <div class="who-text" data-aos="fade-up" data-aos-duration="800"></div>
            <div class="h2 h2_how" data-aos="fade-down" data-aos-duration="800"><h2>活動說明</h2></div>
            <div class="how-list" data-aos="fade-up" data-aos-duration="800">
              <ul>
                <li>即日起至 2026/06/17(三) 23:59 止，填妥以下資料，由ELLE專人審核。</li>
                <li>審核通過者，將收到手機簡訊與E-mail通知，ELLE 將於2026年7月中旬前開始寄送「ELLE美妝之星 BOX」。</li>
                <li>開啟試用，並於 2026年7月底前分享圖文體驗心得於個人 Instagram 帳號，並加入指定 Hashtag：<br><strong>#ELLE美妝圈</strong><strong>#ELLEBEAUTYSTAR2026</strong><strong>#美妝之星</strong><span class="copy-hashtag" data-copy="#ELLE美妝圈 #ELLEBEAUTYSTAR2026 #美妝之星">點此複製 Hashtag</span></li>
              </ul>
            </div>
          </div>
          <!-- 美妝種子招募表單 -->
          ...
          <div class="notice" data-aos="fade-up" data-aos-duration="800">
            ...
            <ol>
              <li>美妝種子名額將依照使用者填寫資料篩選出試用者，每人限報名一次。 </li>
              <li>所有試用品因通訊住址錯漏或郵寄運送過程中造成的損壞、遲遞、錯遞或遺失，ELLE概不負責。請務必正確填寫您的個人資料，以確保您的資格！ </li>
              <li>本活動因不可抗力因素， ELLE有權取消、終止、修改或暫停本活動。 </li>
            </ol>
          </div>
    </section>
    <!-- main content end -->
  ...
  <script>
    ...
    // copy hashtag
    document.querySelectorAll(".copy-hashtag").forEach((el) => {
